...
.Link
https://docs.microsoft.com/powershell/module/az.resourcegraph/get-azresourcegraphquery
#>
...
INPUTOBJECT <IResourceGraphIdentity>: Identity Parameter
  ...
  [SubscriptionId <String>]: The Azure subscription Id.
.Link
https://docs.microsoft.com/powershell/module/az.resourcegraph/remove-azresourcegraphquery
#>
